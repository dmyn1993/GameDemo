...
public class YView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e("YViewWidth", "minimumWidth = " + minimumWidth + "");
        Log.e("YViewHeight", "minimumHeight = " + minimumHeight + "");
        int width = measureWidth(minimumWidth, widthMeasureSpec);
        int height = measureHeight(minimumHeight, heightMeasureSpec);
        Log.e("YViewWidth", "widthMeasureSpec = " + widthMeasureSpec + "");
        Log.e("YViewHeight", "heightMeasureSpec = " + heightMeasureSpec + "");
        setMeasuredDimension(width, height);
        Log.e("YViewWidth", "width = " + width + "");
        Log.e("YViewHeight", "height = " + height + "");
    }
